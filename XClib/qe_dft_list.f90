...
MODULE qe_dft_list
  ...
  SAVE
  !
  INTEGER, PARAMETER :: nxc=11, ncc=14, ngcx=51, ngcc=14, nmeta=7
  ...
  !
  DATA dft_full(42)%name     / 'CAM' /
  DATA dft_full(42)%name2    / 'CAMPBE'  /
  DATA dft_full(42)%IDs(1:6) / 11,4,51,4,0,0 /
  !
CONTAINS
  !
  !------------------------------------------------------------------
